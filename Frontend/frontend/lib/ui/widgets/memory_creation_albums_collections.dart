...
class AlbumsAndCollectionsSelectionWidget extends StatefulWidget {
  final Map<String, AlbumWithSelectedCollections> albums;
  final TabController tabController;
  const AlbumsAndCollectionsSelectionWidget(
      {Key? key, required this.albums, required this.tabController})
      : super(key: key);

  @override
  State<AlbumsAndCollectionsSelectionWidget> createState() =>
      _AlbumsAndCollectionsSelectionWidgetState();
}

class _AlbumsAndCollectionsSelectionWidgetState
    extends State<AlbumsAndCollectionsSelectionWidget>
...
class CollectionSelectionWidget extends StatefulWidget {
  ...
  final List<SimpleCollection> includedCollections;
...
class AlbumSelectionWidget extends StatefulWidget {
  final List<SimpleAlbum> includedAlbums;
