...
class PrivateAlbumTimelineContentGrid extends StatefulWidget {
  final SimplePrivateAlbum album;
  const PrivateAlbumTimelineContentGrid({
    Key? key,
    required this.album,
  }) : super(key: key);

  @override
  State<PrivateAlbumTimelineContentGrid> createState() =>
      _PrivateAlbumTimelineContentGridState();
}

class _PrivateAlbumTimelineContentGridState
    extends State<PrivateAlbumTimelineContentGrid>
