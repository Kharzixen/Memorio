...
class AlbumCreationAddPeople extends StatefulWidget {
  final TabController tabController;
  final TextEditingController nameController;
  final TextEditingController descriptionController;
  const AlbumCreationAddPeople(
      {super.key,
  ...
  @override
  State<AlbumCreationAddPeople> createState() => _AlbumCreationAddPeopleState();
}

class _AlbumCreationAddPeopleState extends State<AlbumCreationAddPeople> {
  @override
  void initState() {
    super.initState();
    context
