...
class PublicAlbumCreationPhotoAndNameSelection extends StatefulWidget {
  final TabController tabController;
  final GlobalKey<FormState> formKey;
  final TextEditingController nameController;
  final TextEditingController descriptionController;

  const PublicAlbumCreationPhotoAndNameSelection(
      {Key? key,
  ...
  @override
  State<PublicAlbumCreationPhotoAndNameSelection> createState() =>
      _PublicAlbumCreationPhotoAndNameSelectionState();
}

class _PublicAlbumCreationPhotoAndNameSelectionState
    extends State<PublicAlbumCreationPhotoAndNameSelection>
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return BlocBuilder<PublicAlbumCreationCubit, PublicAlbumCreationState>(
                        ...
                        showModalBottomSheet(
                            ...
                            builder: (context1) {
                              ...
                              return BlocProvider.value(
                                  value:
                                      BlocProvider.of<PublicAlbumCreationCubit>(
                                          context),
