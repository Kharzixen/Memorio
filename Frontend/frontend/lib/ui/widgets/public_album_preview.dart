...
class PublicAlbumPreviewCard extends StatefulWidget {
  final AlbumPreview albumPreview;
  const PublicAlbumPreviewCard({Key? key, required this.albumPreview})
      : super(key: key);

  @override
  State<PublicAlbumPreviewCard> createState() => _PublicAlbumPreviewCardState();
}

class _PublicAlbumPreviewCardState extends State<PublicAlbumPreviewCard> {
    ...
    return GestureDetector(
      ...
      onTap: () async {
        var returnObject = await context.push(
            "/public-albums/${widget.albumPreview.albumId}",
          ...
          if (popPayload.actionType == ActionType.leaved) {
            if (context.mounted) {
              context
                  ...
                  .leaveAlbum(widget.albumPreview.albumId);
            }
          }
        }
      },
