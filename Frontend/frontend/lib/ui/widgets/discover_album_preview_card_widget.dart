...
class DiscoverPublicALbumPreviewCard extends StatefulWidget {
  final AlbumPreview albumPreview;
  const DiscoverPublicALbumPreviewCard({Key? key, required this.albumPreview})
      : super(key: key);

  @override
  State<DiscoverPublicALbumPreviewCard> createState() =>
      _DiscoverPublicALbumPreviewCardState();
}

class _DiscoverPublicALbumPreviewCardState
    extends State<DiscoverPublicALbumPreviewCard> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        context.push("/public-albums/${widget.albumPreview.albumId}",
                        ...
                        var response = await showModalBottomSheet(
                            ...
                            builder: (BuildContext context1) {
                              return CreatePublicMemoryBottomSheet(
                                album: SimplePublicAlbum.fromAlbumPreview(
                                    widget.albumPreview),
                              );
                            });
                        if (response != null) {
                          ...
                          if (popResponse.actionType == ActionType.created &&
                            ...
                            context
                                ...
                                .addNewPhotoToAlbum(widget.albumPreview.albumId,
                                    response.data as PublicMemory);
                          }
                        }
                        break;
