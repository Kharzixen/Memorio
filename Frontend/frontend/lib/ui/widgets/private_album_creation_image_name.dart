...
class PrivateAlbumCreationPhotoAndNameSelection extends StatefulWidget {
  final TabController tabController;
  final GlobalKey<FormState> formKey;
  final TextEditingController nameController;
  final TextEditingController descriptionController;

  const PrivateAlbumCreationPhotoAndNameSelection(
      {Key? key,
  ...
  @override
  State<PrivateAlbumCreationPhotoAndNameSelection> createState() =>
      _PrivateAlbumCreationPhotoAndNameSelectionState();
}

class _PrivateAlbumCreationPhotoAndNameSelectionState
    extends State<PrivateAlbumCreationPhotoAndNameSelection>
