...
class PostImageAndDescriptionWidget extends StatefulWidget {
  final Uint8List image;
  final TabController tabController;
  const PostImageAndDescriptionWidget(
      {Key? key, required this.image, required this.tabController})
      : super(key: key);

  @override
  State<PostImageAndDescriptionWidget> createState() =>
      _PostImageAndDescriptionWidgetState();
}

class _PostImageAndDescriptionWidgetState
    extends State<PostImageAndDescriptionWidget>
                ...
                if (state is PostCreationInProgressState) {
                  if (!state.saveInProgress && !state.savedToGallery) {
                    return TextButton(
                      ...
                      onPressed: () {
                        context.read<CreatePostCubit>().saveImage();
                      },
                      child: Center(
                        child: Padding(
