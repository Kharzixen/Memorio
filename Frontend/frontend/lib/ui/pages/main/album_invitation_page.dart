...
class AlbumInvitationPage extends StatefulWidget {
  final String albumId;
  const AlbumInvitationPage({super.key, required this.albumId});

  @override
  State<AlbumInvitationPage> createState() => _AlbumInvitationPageState();
}

class _AlbumInvitationPageState extends State<AlbumInvitationPage> {
  @override
  void initState() {
    super.initState();
    context
