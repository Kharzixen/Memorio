                  ...
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (BuildContext context) {
                      ...
                      if (state.collectionPreview.creator.userId ==
                        ...
                        options = {'Edit', 'Remove', 'Add photo', 'Hide'};
                      } else {
              ...
              body: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    Text(
                      "Description:",
                      style: GoogleFonts.lato(color: Colors.blue, fontSize: 19),
                    ),
                    Padding(
                    ...
                    Row(
                      children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(
                                      state.collectionPreview.creator.pfpLink),
                                ),
                        ...
                        Column(
                          children: [
                            Text(
                              getDate(state.collectionPreview.creationDate),
                              style: GoogleFonts.lato(
                                color: Colors.white,
                                fontSize: 12,
                              ),
                            ...
                            Text(
                              getHour(state.collectionPreview.creationDate),
                              style: GoogleFonts.lato(
                                color: Colors.white,
                                fontSize: 12,
                              ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                            ...
                                            showModalBottomSheet<void>(
                                              ...
                                              builder: (BuildContext context) {
                                                return CustomBottomSheet(
                                                  album: state.collectionPreview
                                                      .simpleAlbum,
                                                  collection: SimpleCollection
                                                      .fromCollectionPreview(state
                                                          .collectionPreview),
                                                );
                                              },
                                            );
                                      ...
                                      state.collectionPreview.creator.userId ==
                                              StorageService().userId
                                          ? IconButton(
                                              onPressed: () {},
                                              icon: const Icon(
