...
class PublicAlbumInfoPage extends StatelessWidget {
  final String albumId;
  const PublicAlbumInfoPage({super.key, required this.albumId});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: BlocBuilder<PublicAlbumCubit, PublicAlbumState>(
          builder: (context, state) {
            if (state is PublicAlbumLoadingState) {
              return const Center(
                child: CircularProgressIndicator(),
              );
            }

            if (state is PublicAlbumLoadedState) {
              return Stack(
                children: [
                  RefreshIndicator.adaptive(
                    ...
                    onRefresh: () async {
                      var bloc = context.read<PublicAlbumCubit>().stream.first;
                      context.read<PublicAlbumCubit>().refreshAlbumInfoPage();
                      await bloc;
                    },
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return TextButton(
                                          onPressed: () {
                                            context.push(
                                                "/public-albums/${state.albumInfo.albumId}/contributors/${state.contributors[index].userId}");
                                          },
                                                                      ...
                                                                      actions: [
                                                                        TextButton(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            context.read<PublicAlbumCubit>().removeUserFromAlbum(state.contributors[index].userId);
                                                                          },
                                                                        ),
                                                                        TextButton(
                                                                          child: Text(
            ...
            if (state is LeavedPublicAlbumState) {
              WidgetsBinding.instance.addPostFrameCallback(
                (_) {
                  context.pop(PopPayload<String>(ActionType.leaved, albumId));
                },
              );
              return Container();
            }
