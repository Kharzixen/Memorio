...
public class DisposableCameraService {
    ...
    @Transactional
    public DisposableCameraDtoOut patchDisposableCameraOfAlbum(Long albumId, DisposableCameraPatchDtoIn patchDtoIn) {
        ...
        //if the user wants to make the disposable camera active
